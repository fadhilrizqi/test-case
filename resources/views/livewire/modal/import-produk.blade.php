<!-- Main modal -->
<div id="import-produk" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-xl shadow dark:bg-gray-700">
            ...
            <div class="flex justify-between items-start p-6 rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="import-produk">
            ...
            <!-- Modal body -->
            <div class="px-5">
                <form class="max-h-96 overflow-y-auto px-1" action="{{ route('product-import') }}"
                    enctype="multipart/form-data" method="GET">
                    <div class="">
                        <h1 class="text-sm mb-5 font-semibold text-gray-500">Silahkan upload file untuk menambahkan
                            produk secara masal. Unduh template file <a href="" class="text-blue-600">Disini</a>
                        </h1>
                        <label for=""
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Unggah File</label>
                        <div class="relative mb-6">
                            ...
                            <label for="file-upload"
                                class="bg-gray-50 border border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5">
                                Import File
                            </label>
                    ...
                    <div class="flex mb-6 gap-5 justify-end">
                        ...
                        <button data-modal-toggle="import-produk" type="submit"
                            class="text-white text-sm px-10 py-2 bg-blue-600 rounded-lg">
                            Simpan
                        </button>
                    </div>
                </form>
