<div class="relative bg-white p-5 rounded-xl overflow-hidden">
            ...
            <tbody class="text-gray-900">
                <tr class="bg-white border-b">
                    ...
                    <td class="py-4 px-6 truncate font-semibold max-w-xs">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut adipisci amet, maxime tempora enim
                        nisi labore assumenda delectus! Quasi maxime libero in ipsam alias magnam at dolore est
                    ...
                    <td class="py-4 px-6 truncate font-semibold">
                        ...
                        <div id="dropdownDetailToko"
                            ...
                            <ul class="py-2 text-sm text-gray-600 dark:text-gray-200"
                            ...
                            <td class="py-4 px-6">
                                <div class="flex flex-row items-center font-semibold gap-5">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-gray-500 text-xs">{{ $dt->sku }}</span>
                                    </div>
                                </div>
                            </td>
                            <td class="py-4 px-6 truncate font-semibold max-w-xs">
    ...
    <div
        class="text-sm flex justify-center gap-5 flex-col md:flex-row md:justify-between text-gray-700 bg-white rounded-b-lg px-5 pt-5">
        <div class="flex items-center gap-4">
            Show
            <select
                class="bg-gray-100 border  border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-16 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
