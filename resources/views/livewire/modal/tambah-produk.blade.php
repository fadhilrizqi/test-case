<!-- Main modal -->
<div id="tambah-produk" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-xl shadow dark:bg-gray-700">
            ...
            <div class="flex justify-between items-start p-6 rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="tambah-produk">
            ...
            <div class="px-5">
                <form wire:submit.prevent="store" enctype="multipart/form-data">
                    ...
                    <div class="flex mb-6 gap-5 justify-end">
                        <button data-modal-toggle="tambah-produk" wire:click.prevent="cancel()"
                            class="text-white text-sm px-10 py-2 bg-gray-400 rounded-lg">
                            Batal
                        </button>
                        <button data-modal-toggle="tambah-produk" type="submit"
