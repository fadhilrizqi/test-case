    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-xl shadow dark:bg-gray-700">
            ...
            <div class="flex justify-between items-start p-6 rounded-t dark:border-gray-600">
                ...
                <button type="button" class="text-red-500 bg-red-200 text-primaryRed bg-transparent rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="import-produk">
