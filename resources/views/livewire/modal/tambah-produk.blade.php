<!-- Main modal -->
<div id="tambah-produk" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-xl shadow dark:bg-gray-700">
            ...
            <div class="flex justify-between items-start p-6 rounded-t dark:border-gray-600">
                ...
                <button type="button" class="text-red-500 bg-red-200 bg-transparent hover:bg-gray-200 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="tambah-produk">
            ...
            <div class="px-5">
                <form class="max-h-96 overflow-y-auto px-1" action="">
                    ...
                    <div class="flex mb-6 gap-5 justify-end">
                        <button data-modal-toggle="tambah-produk" type="button" class="text-white text-sm px-10 py-2 bg-gray-400 rounded-lg"> 
                            Batal
                        </button>
                        <button data-modal-toggle="tambah-produk" type="button" class="text-white text-sm px-10 py-2 bg-red-600 rounded-lg"> 
                            Simpan
                        </button>
                    </div>
                </form>
