<!-- Main modal -->
<div id="edit-produk" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-xl shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div class="px-5">
                <form class="max-h-96 overflow-y-auto px-1" action="{{ route('product-update') }}"
                    ...
                    <div class="mb-6 w-max">
                        ...
                        <label type="file" name="image-product" id="image-product" required>
                            <span>
                                <img src="assets/images/image.png" {{-- url('/product_image/' . $data->image) --}}
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="nama-produk" value="{{ $data->nama ?? '' }}"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="sku-produk" value="{{ $data->sku ?? '' }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="desc" id="desc" rows="4"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Tulis deskripsi disini" required>{{ $data->desc ?? '' }}</textarea>
                    </div>
                    <div class="mb-6">
                        <label for="kategori"
                        ...
                        <select id="kategori"
                            ...
                            <option selected value="{{ $data->kategori ?? '' }}">
                                {{ $data->kategori ?? 'Pilih Kategori Produk' }}</option>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="harga-produk" value="{{ $data->harga ?? '' }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div class="flex mb-6 gap-5 justify-end">
                        ...
                        <button data-modal-toggle="edit-produk" type="submit"
